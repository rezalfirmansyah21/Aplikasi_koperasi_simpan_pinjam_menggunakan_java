...
public class FormSimpanan extends javax.swing.JFrame {
    ...
    public FormSimpanan() {
        ...
        tglupdate.setDateFormat(new SimpleDateFormat("yyyy-MM-dd")); //yyyy-MM-dd
        loadData();
     //   kode();
        setJam();
    }
...
//    }
    ...
    private void initComponents() {
        ...
        tabelrekening = new javax.swing.JTable();
        ...
        tglupdate = new org.freixas.jcalendar.JCalendarCombo();
        ...
        tabelrekening.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tabelrekening.setSelectionBackground(new java.awt.Color(0, 0, 0));
        tabelrekening.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tabelrekeningMouseClicked(evt);
            }
        });
        jScrollPane2.setViewportView(tabelrekening);
        ...
        jPanel1Layout.setHorizontalGroup(
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtsaldo, javax.swing.GroupLayout.DEFAULT_SIZE, 250, Short.MAX_VALUE)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(txtcarianggota, javax.swing.GroupLayout.PREFERRED_SIZE, 267, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnhapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnhapusActionPerformed
        // TODO add your handling code here:
          if(txtid.getText().equals("") ||txtnama.getText().equals("") || txtsaldo.getText().equals("")|| tglupdate.getSelectedItem().equals("")){
            JOptionPane.showMessageDialog(null, "LENGKAPI DATA !", "Koperasi", JOptionPane.INFORMATION_MESSAGE);
        }else{
        try {
            String sql ="delete from rekening where id='"+txtid.getText()+"'";
    ...
    private void btntambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btntambahActionPerformed
        // TODO add your handling code here:
           if(txtid.getText().equals("") ||txtnama.getText().equals("") || txtsaldo.getText().equals("")|| tglupdate.getSelectedItem().equals("")){
            ...
            String saldoo = txtsaldo.getText();
            String tglup = (String) tglupdate.getSelectedItem();
    ...
    private void btnubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnubahActionPerformed
        // TODO add your handling code here:
           int i = tabelrekening.getSelectedRow();
        if (i == -1) {
            return;
        }
        ...
        try {
            Connection c = koneksi.getKoneksi();
            String sql = "UPDATE rekening SET nama =  '" + txtnama.getText() + "',saldo='" + txtsaldo.getText() + "',tanggal='" + tglupdate.getSelectedItem() + "' WHERE  id ='" + idd + "'";
            PreparedStatement p = c.prepareStatement(sql);
            p.executeUpdate();
            p.close();
        } catch (SQLException e) {
    ...
    private void tabelrekeningMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelrekeningMouseClicked
        // TODO add your handling code here:
     ...
     //   txtid.setEnabled(false);
        ...
        txtsaldo.setText(notelpp);
        
        String tglup = (String) model.getValueAt(i, 3);
        tglupdate.setSelectedItem(tglup);

    }//GEN-LAST:event_tabelrekeningMouseClicked
    ...
    private void txtcariKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtcariKeyReleased
        ...
        try {
            ...
            String sql = "select * from rekening where id like '%" + txtcari.getText() + "%' or nama like'%" + txtcari.getText() + "%' or saldo like'" + txtcari.getText() + "%' or tanggal like'" + txtcari.getText() +"%'";
            ResultSet r = s.executeQuery(sql);
    ...
    private javax.swing.JTable tabelrekening;
    private javax.swing.JLabel tgl;
    private javax.swing.JLabel tgl2;
    private org.freixas.jcalendar.JCalendarCombo tglupdate;
