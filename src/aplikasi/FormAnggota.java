...
new Timer(1000, taskPerformer).start();
    ...
    private void initComponents() {
        ...
        txttelp.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        ...
        txtalamat.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        ...
        txtpekerjaan.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
    ...
    private void btnhapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnhapusActionPerformed
        // TODO add your handling code here:
          if(txtid.getText().equals("") ||txtnama.getText().equals("") || txttelp.getText().equals("")|| txtalamat.getText().equals("")|| txtpekerjaan.getText().equals("")){
            JOptionPane.showMessageDialog(null, "LENGKAPI DATA !", "Koperasi", JOptionPane.INFORMATION_MESSAGE);
        }else{
        try {
            String sql ="delete from anggota where id='"+txtid.getText()+"'";
    ...
    private void btntambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btntambahActionPerformed
        // TODO add your handling code here:
           if(txtid.getText().equals("") ||txtnama.getText().equals("") || txttelp.getText().equals("")|| txtalamat.getText().equals("")|| txtpekerjaan.getText().equals("")){
            ...
            String pekerjaann = txtpekerjaan.getText();
    ...
    private void btnubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnubahActionPerformed
        ...
        try {
            Connection c = koneksi.getKoneksi();
            String sql = "UPDATE anggota SET nama =  '" + txtnama.getText() + "',no_telp='" + txttelp.getText() + "',pekerjaan='" + txtpekerjaan.getText() + "',alamat='" + txtalamat.getText() + "' WHERE  id ='" + idd + "'";
            PreparedStatement p = c.prepareStatement(sql);
            p.executeUpdate();
            p.close();
        } catch (SQLException e) {
    ...
    private void tabelanggotaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelanggotaMouseClicked
     ...
     //   txtid.setEnabled(false);
        ...
        String pekerjaann = (String) model.getValueAt(i, 3);
        txtpekerjaan.setText(pekerjaann);

        String alamatt = (String) model.getValueAt(i, 4);
    ...
    private void txtcariKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtcariKeyReleased
        ...
        try {
            ...
            String sql = "select * from anggota where id like '%" + txtcari.getText() + "%' or nama like'%" + txtcari.getText() + "%' or no_telp like'" + txtcari.getText() + "%' or pekerjaan like'" + txtcari.getText() + "%' or alamat like'%" + txtcari.getText() +"%'";
            ResultSet r = s.executeQuery(sql);
